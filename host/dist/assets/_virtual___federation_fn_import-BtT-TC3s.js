...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-DfDSfpvY.js', import.meta.url).href),import:true},'vue-router':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-router-BvU9WogW.js', import.meta.url).href),import:true},'pinia':{get:()=>()=>__federation_import(new URL('__federation_shared_pinia-BgYYI71o.js', import.meta.url).href),import:true}};
