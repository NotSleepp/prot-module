...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-DfDSfpvY.js', import.meta.url).href),import:true},'vue-router':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-router-D_7WiVGH.js', import.meta.url).href),import:true},'pinia':{get:()=>()=>__federation_import(new URL('__federation_shared_pinia-kggbrtuh.js', import.meta.url).href),import:true},'mitt':{get:()=>()=>__federation_import(new URL('__federation_shared_mitt-CMmIqmsj.js', import.meta.url).href),import:true}};
